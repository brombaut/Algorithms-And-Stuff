---
title: "Chapter 2 - Statistical Learning - Applied"
...
8(b) Look at the data using the fix() function. Note the first column is just the name of the university. We don't want R to treat this as data. Give each row a name corresponding to the appropriate university, so that R will not try to perform calculations on the row names. However, we still need to eliminate the first column in the data where the names are stored.
```{r}
